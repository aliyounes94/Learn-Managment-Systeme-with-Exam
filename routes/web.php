...
// Evaluation routes
    ...
    Route::group(['namespace' => 'SupportTeam'], function(){
        Route::group(['prefix' => 'teacher-evaluations'], function () {
            Route::get('/{teacher_id}', 'TeacherEvaluationController@show')->name('teacher.evaluations.show');
            Route::get('/{teacher_id}/create', 'TeacherEvaluationController@create')->name('teacher.evaluations.create');
            Route::post('/store', 'TeacherEvaluationController@store')->name('teacher.evaluations.store');
        });
        Route::get('/teachers', 'TeacherEvaluationController@index')->name('teacher.index');
        ...
        Route::group(['prefix' => 'students'], function(){
            ...
            Route::get('/quizzes', 'QuizController@index')->name('quizzes.index');
            Route::post('quizzes/{quiz}/save-grade', 'QuizController@saveGrade')->name('quizzes.save-grade');
           
            Route::post('/teachers/{teacher_id}/evaluate', 'TeacherEvaluationController@evaluate')
            ->name('teachers.evaluate')
        ...
        Route::get('quizzes/{quiz_id}/attempt', 'QuizController@attempt')->name('quizzes.attempt');
        Route::post('quizzes/{quiz_id}/submit', 'QuizController@submit')->name('quizzes.submit');
        Route::group([ 'middleware' => 'teamSAT'], function(){
