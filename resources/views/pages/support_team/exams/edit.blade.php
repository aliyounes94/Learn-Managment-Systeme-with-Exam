                ...
                <div class="col-md-6">
                    <form method="post" action="{{ route('exams.update', $ex->id) }}">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">NameTTT <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Submit formS <i class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
            </div>
