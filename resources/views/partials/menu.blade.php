                ...
                @if(Qs::userIsAcademic())
                    <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['tt.index', 'ttr.edit', 'ttr.show', 'ttr.manage']) ? 'nav-item-expanded nav-item-open' : '' }} ">
                        ...
                        {{--Timetables--}}
                            ...
                            <li class="nav-item">  
    <a href="{{ route('teacher.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['tt.index']) ? 'active' : '' }}">
        Teacher Evaluation
    </a>
</li>
                        </ul>
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Manage Exams">
                        ...
                        @if(Qs::userIsTeamSAT())
                           ...
                           <a href="{{ route('quizzes.create') }}" 
                             class="nav-link {{ request()->routeIs('quizzes.create') ? 'active' : '' }}">
                               New EXAM
                              </a>
                              </li>
                ...
                <li class="nav-item">
                           <a href="{{ route('quizzes.index') }}" 
                             class="nav-link {{ request()->routeIs('quizzes.index') ? 'active' : '' }}">
                               Show all EXAM
                              </a>
                              </li>
                </ul>
