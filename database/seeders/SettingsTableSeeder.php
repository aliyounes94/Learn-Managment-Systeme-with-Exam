...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_name', 'description' => 'LearnManagment Systeme'],
            ['type' => 'term_ends', 'description' => '7/10/2025'],
            ['type' => 'term_begins', 'description' => '7/10/2026'],
            ['type' => 'phone', 'description' => '0123456789'],
            ['type' => 'address', 'description' => 'Syria,Damascuse'],
            ['type' => 'system_email', 'description' => 'lms@gmail.com.com'],
